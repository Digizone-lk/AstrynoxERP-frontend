...
import { CardGridSkeleton } from "@/components/ims/skeletons";
              ...
              <CardContent className="pt-5">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1 min-w-0">
                    <Link href={`/ims/products/${p.id}`} className="font-semibold text-slate-800 hover:text-blue-600 truncate block">{p.name}</Link>
