...
export default function NewQuotationPage() {
  ...
  const createMut = useMutation({
    ...
    onSuccess: (res) => {
      ...
      router.push(`/ims/quotations/${res.data.id}`);
    },
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        <Link href="/ims/quotations"><Button variant="ghost" size="sm"><ArrowLeft size={16} className="mr-1" />Back</Button></Link>
      ...
      <div className="max-w-4xl space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Link href="/ims/quotations"><Button variant="outline">Cancel</Button></Link>
          <Button
